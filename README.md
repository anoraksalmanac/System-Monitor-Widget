...
## feature list
- Tempature monitoring for your CPU and GPU
- Usage monitoring for your CPU and GPU
- RAM VRAM and SWAP monitoring
...
make sure to cd into your downloads folder - or wherever you placed the .deb - and run the install command or some OSs allow you to double click the .deb and automatically install it.
